...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    jobAlertsAuthUserSubject.add(
      JobAlertsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<JobAlertsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  JobAlertsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = JobAlertsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    jobAlertsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
