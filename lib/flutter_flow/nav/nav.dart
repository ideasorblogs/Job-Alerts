...
class AppStateNotifier extends ChangeNotifier {
  ...
  JobAlertsAuthUser? initialUser;
  JobAlertsAuthUser? user;
  ...
  void update(JobAlertsAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const LanguageselectorWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => const LanguageselectorWidget(),
        ),
        FFRoute(
          name: 'details',
          path: '/details',
        ...
        FFRoute(
          ...
          path: '/postcategorydetails',
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: PostcategorydetailsWidget(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/practicepedia_favicon_logo.png',
                      width: 150.0,
                      fit: BoxFit.cover,
                    ),
                  ),
